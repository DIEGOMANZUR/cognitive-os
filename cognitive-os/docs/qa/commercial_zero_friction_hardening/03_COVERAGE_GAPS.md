...
| GAP-004 | P2 | Docs | Algunos docs secundarios mantienen texto pre-zero-friction | USER_GUIDE/ACTION_PLANE | Futuros agentes reintroducen friccion | Corregido: docs principales y QA actualizados al snapshot 943/31 + live/TestSprite |
